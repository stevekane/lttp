...
"use strict";
var __moduleName = "public/entities/Wall";
module.exports = (function($__super) {
  var Wall = function Wall(state, x, y) {
    $traceurRuntime.superCall(this, Wall.prototype, "constructor", [state, y, y, "wall"]);
    state.physics.arcade.enable(this);
    this.body.collideWorldBounds = true;
    this.immovable = true;
    this.anchor.set(.5);
  };
  return ($traceurRuntime.createClass)(Wall, {}, {}, $__super);
}(Phaser.Sprite));
...
},{"./states/Round":6,"lodash":"K2RcUv"}],6:[function(require,module,exports){
"use strict";
