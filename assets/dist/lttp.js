...
module.exports = (function($__super) {
  var Player = function Player(state, x, y) {
    $traceurRuntime.superCall(this, Player.prototype, "constructor", [state, x, y, "player"]);
...
module.exports = (function($__super) {
  ...
  return ($traceurRuntime.createClass)(Round, {
    ...
    create: function() {
      ...
      this.inputs = [{
        key: upKey,
        fn: player1.moveUp.bind(player1)
      }, {
        key: rightKey,
        fn: player1.moveRight.bind(player1)
      }, {
        key: downKey,
        fn: player1.moveDown.bind(player1)
      }, {
        key: leftKey,
        fn: player1.moveLeft.bind(player1)
      }];
...
var doIfPressed = (function(input) {
  if (input.key.isDown)
    input.fn();
});
